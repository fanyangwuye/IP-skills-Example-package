...
RECOMMENDED_FIELD_QUESTIONS = {
    ...
    "character_profile.appearance.facial_proportions": "角色五官比例是什么？例如三庭五眼、眼距、鼻口距离、下庭长短。",
    "character_profile.appearance.brow_shape": "角色眉型是什么？",
    "character_profile.appearance.eye_shape": "角色眼型是什么？",
    "character_profile.appearance.nose_shape": "角色鼻型是什么？",
    "character_profile.appearance.mouth_shape": "角色口型是什么？",
