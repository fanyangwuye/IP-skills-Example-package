...
- `scripts/asset_manifest.py`: asset manifest template builder, directory scanner, and loader for character, scene, storyboard, and space-anchor reference binding
