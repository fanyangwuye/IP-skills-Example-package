...
- `prompt_architecture_audit`: test generated video prompts offline for fixed sections, provider-specific variants, length budgets, storyboard execution mapping, all-purpose-reference wording, spatial templates, and no subtitle/BGM drift.
...
- `scripts/prompt_architecture_audit.py`: offline Prompt Packet V1 audit for full and provider-specific clip prompts
...
- `assets/example_prompt_architecture_audit_task.json`: offline prompt architecture audit example
